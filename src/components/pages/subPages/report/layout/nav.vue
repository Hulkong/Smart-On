<template>
  ...
  <div id="nav" :class="{ on: isNarrow }">
    <ul>
      <li>
        <a href="###">
          <img src="/src/assets/images/common/ic_search_001_128h.png" alt />
        </a>
        ...
        <div class="search_map">
          ...
          <div style="position: absolute; top:60%; width:100%; height: 40%;">
            <div style="position: absolute; width:50%; height: 50%;">
              <p>인구수</p>
              <p>{{ numberWithCommas(navMap.popltn) }}</p>
            </div>
      ...
      <li>
        <router-link to="/">
          <img src="/src/assets/images/common/ic_home_001_128h.png" alt />
          <span>Home</span>
        </router-link>
      </li>
      <li>
        <router-link to="/report/about">
          <img src="/src/assets/images/common/ic_question_002_128h.png" alt />
          <span>About</span>
        </router-link>
      </li>
      <li>
        <router-link to="/report/contact">
          <img src="/src/assets/images/common/ic_message_001_128h.png" alt />
          <span>Contact</span>
        </router-link>
      </li>
      <li v-show="!isNarrow">
